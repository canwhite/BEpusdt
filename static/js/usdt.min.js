(function () {
    ...
    function addBackButton() {
        ...
        if (container && paymentConfig.return_url) {
            var backDiv = document.createElement('div');
            backDiv.style.cssText = 'text-align:left;margin-bottom:15px;';
            var link = document.createElement('a');
            link.href = paymentConfig.return_url;
            link.style.cssText = 'color:#667eea;text-decoration:none;font-size:14px;';
            link.innerHTML = '&larr; 返回商户平台';
            backDiv.appendChild(link);
